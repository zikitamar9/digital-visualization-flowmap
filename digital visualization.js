...
function convert_country_to_long_lat(country_name) \{\
  return \{\
    latitude: countries[country_name][0],\
    longitude: countries[country_name][1]\
  \}\
\
\}\
\
function coordinates_to_sumba(country_name) \{\
  return \{\
    origin: convert_country_to_long_lat(country_name),\
    destination: sumba\
  \}\
\
\}\
...
console.log(i);\
all_paths.push(\{ \
  origin: convert_country_to_long_lat(i),\
  destination: sumba\
\})\
\
\
